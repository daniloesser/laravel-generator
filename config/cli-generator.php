    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        'use' => [
            // CliGenerator\Database\Eloquent\BitBooleans::class,
            // CliGenerator\Database\Eloquent\BlamableBehavior::class,
        ],
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | If you have a prefix on model names specify it here.
        |
        */
