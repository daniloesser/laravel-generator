...
use CliGenerator\Code\Model\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Model as Eloquent;
use CliGenerator\Code\Model\Relations\ReferenceFactory;

class Model
{
    /**
     * @var \CliGenerator\Meta\Blueprint
     */
    private $blueprint;
    ...
    /**
     * @var \CliGenerator\Code\Model\Mutation[]
     */
    protected $mutations = [];
    ...
    protected function configure()
    {
        ...
        // Model Prefix settings
        $this->withModelPrefix($this->config('model_prefix', $this->getDefaultModelPrefix()));
     ...
     *
     * @return $this|\CliGenerator\Code\Model\Model
     */
    ...
    /**
     * @param \CliGenerator\Meta\Blueprint[] $references
     */
     ...
     */
    public function withModelPrefix($modelPrefix)
    {
     ...
     * @return string
     */
    public function getDefaultModelPrefix()
    {
        return '';
    }
    ...
    /**
     * @return \CliGenerator\Code\Model\Mutation[]
     */
