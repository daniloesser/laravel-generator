...
use CliGenerator\Meta\MySql\Schema as MySqlSchema;
use CliGenerator\Meta\Sqlite\Schema as SqliteSchema;
use CliGenerator\Meta\Postgres\Schema as PostgresSchema;
